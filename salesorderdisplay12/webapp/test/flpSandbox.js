		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SO for partners",
									"targetURL": "#namespace2salesorderdisplay12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespace2salesorderdisplay12-display": {
								"semanticObject": "namespace2salesorderdisplay12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namespace2.salesorderdisplay12",
									"url": sap.ui.require.toUrl("namespace2/salesorderdisplay12")
								}
							}
						}
					}
